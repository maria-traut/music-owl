    ...
    <StyledMain>
      <section>
        ...
        <p>
          ...
          who matter most. Here is what you can do:
        </p>
        <StyledLinkWrapper>
          <span>
            Add the people you want to create music lists for. All you need is a
            name and their year of birth.
          </span>
          <span>
            Create personalized playlists for each person — filled with the
            songs that shaped their life.
          </span>
          <span>
      ...
      <br />
      <section>
        <StyledH3>Millions of Families. One Shared Challenge.</StyledH3>
        <p>
